...
def test_react_agent():
    ...
    # register search tool (if avaiable)
    try:
    ...
    # test 2: search problem
    print("\n🔍 测试2：信息搜索问题")
    search_question = "Python 编程语言是什么时候发布的？请告诉我具体的年份。"
    ...
    # test 3: 复合问题（需要多步推理）
    print("\n🧠 测试3：复合推理问题")
    complex_question = "如果一个班级有30个学生，其中 60% 是女生，那么男生有多少人？请先计算女生人数，再计算男生人数。"
...
def test_custom_prompt():
    ...
    # custom prompt (more simple version)
    custom_prompt = """你是一个数学专家 AI 助手。
