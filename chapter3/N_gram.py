...
# print(f"bigram 频率统计: {bigrams_counts}")
...
p_leanrs_given_agent = count_agent_learns / count_agent
print(f"第三步: P(learns|agent) = {count_agent_learns} / {count_agent} = {p_leanrs_given_agent:.3f}")

# --- 最后：将概率连乘 ---
p_sentence = p_datawhale * p_agent_given_datawhale * p_leanrs_given_agent
print(f"最后: P('datawhale agent learns') ≈ {p_sentence:.3f} * {p_agent_given_datawhale:.3f} * {p_leanrs_given_agent:.3f} = {p_sentence:.3f}")
